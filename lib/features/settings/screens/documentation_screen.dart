    ...
    articles: [
      ...
      _DocArticle(
        ...
        body:
            ...
            '4. You will be redirected to the Dashboard immediately after sign-up\n\n'
      ...
      _DocArticle(
        ...
        body:
            ...
            'Settings - Account management, API keys, notifications, and preferences\n\n'
    ...
    articles: [
      ...
      _DocArticle(
        ...
        body:
            ...
            'Warning: Revocation is immediate and irreversible. Any service using that key will '
